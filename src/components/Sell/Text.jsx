...
const ResponsiveText = () => {
  return (
    <div className="p-6 flex flex-col bg-black justify-center  text-center bg-cover bg-center">
      ...
      <div className="description mt-1 p-4 rounded-lg ">
        <p className="lg:text-xl xs:text-lg font-poppins md:text-lg sm:text-base text-white">
